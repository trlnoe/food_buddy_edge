...
echo "[1/4] Cập nhật hệ thống và cài đặt môi trường cơ bản..."
sudo apt-get update
...
then
    echo "[2/4] Đang cài đặt Docker và Docker Compose..."
    ...
    echo "[2/4] Docker đã được cài đặt, bỏ qua..."
fi

# 3. Download Model if missing
echo "[3/4] Kiểm tra và tải mô hình Qwen 0.5B GGUF..."
...
echo "[4/4] Đang triển khai các AI Agents qua Docker Compose..."
